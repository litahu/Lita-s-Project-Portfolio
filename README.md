...
---|---|---|---
🎫 [Previsión de fondos](https://github.com/litahu/Data-Analytics-in-SQL-de-Potenciar-Solidario/tree/main#-Visualización-de-datos![image](https://github.com/user-attachments/assets/e3bd807a-bd21-43a7-8ac5-1d30fddb0db1)) | Fundación Potenciar Solidario | Power BI | Realicé ETL, calcule medidas para identificar el cumplimiento finaciero que sostiene actualmente la ONG y logré proyetar su tendencia futura
