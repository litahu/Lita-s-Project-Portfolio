...
Project Link | Associated | Tools | Project Description
---|---|---|---
🦾 [ Fundamentos de Inteligencia artificial](https://github.com/litahu/Rendimiento_E-commerce/tree/main/Sprint_1) |  Programa de formación brindado por Guayerd | Python, Prompt Engineering | Los proyectos desarrollados me permitieron perfeccionar la creación de prompts, automatizar procesos y aplicar principios de ética y seguridad de datos en soluciones de IA.
