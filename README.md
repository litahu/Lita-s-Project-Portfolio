...
---|---|---|---
🛒 [Seguimiento de ventas](https://github.com/litahu/Seguimiento_de_ventas/blob/main/README.md) | EmpowerTravel Store | Power BI | Analicé la facturación de la cadena de tiendas por productos de marca para el año 2024
🎫 [Previsión de fondos](https://github.com/litahu/Data-Analytics-in-SQL-de-Potenciar-Solidario/tree/main#-Visualización-de-datos) | Fundación Potenciar Solidario | Power BI | Realicé ETL, calcule medidas para identificar el cumplimiento finaciero que sostiene actualmente la ONG y logré proyetar su tendencia futura
